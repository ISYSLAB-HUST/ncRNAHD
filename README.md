...
rMSA: Clone the rMSA repository and replace rMSA.pl with the provided version
trRosettaRNA2: Use trRosettaRNA2/scripts/search_MSA.sh
Performance Notes
...
GitHub: @elkerist
Repository: ISYSLAB-HUST/ncRNAHD
License
